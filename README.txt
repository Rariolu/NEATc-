...
NeuralUtil is a library that contains some formatting methods for normalising and denormalising neural-net I/O as well as a couple of scripts used to facilitate the use of this API with the Unity engine.
